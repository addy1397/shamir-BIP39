...
* Details:    Defines the API for computing gf256 computations.
              This API can be used to compute addition, subtraction, 
              multiplication and division operations using look-up
              tables in galois field(256).              
*************************************************************************/
...
/*
    ------------------------------------------------------------------------
    LOG[] and EXP[] are used as lookup tables for multiplication and division 
    operations in galois field(256).
    ------------------------------------------------------------------------
*/
...
/*
    ------------------------------------------------------------------------
    add() -> Returns the addition of two 8-bit numbers in galois field(256).
    ------------------------------------------------------------------------
*/
...
/*
    ------------------------------------------------------------------------
    sub() -> Returns the subtraction of two 8-bit numbers in galois field(256).
    ------------------------------------------------------------------------
*/
...
/*
    ------------------------------------------------------------------------
    mul() -> Returns the multiplication of two 8-bit numbers in galois field(256).
    ------------------------------------------------------------------------
*/
static byte mul(byte a, byte b)
{
    ...
    return EXP[unsigned(LOG[unsigned(a)]) + unsigned(LOG[unsigned(b)])];
}

/*
    ------------------------------------------------------------------------
    div() -> Returns the division of two 8-bit numbers in galois field(256).
    ------------------------------------------------------------------------
*/
static byte div(byte a, byte b)
{
    return mul(a, EXP[255 - unsigned(LOG[unsigned(b)])]);
}
